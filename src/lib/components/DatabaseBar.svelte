<div class="container flex gap-4 md:gap-10 py-8 font-secondary ">
    <img src="dbs/sqlite.png" alt="" class="h-16">
    <img src="dbs/postgre.png" alt="" class="h-16 grayscale opacity-60">
