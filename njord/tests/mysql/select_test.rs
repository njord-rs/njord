...
// FIXME: Figure out how to implement these below
// #[test]
// fn select_except() {
//     let url = "mysql://njord_user:njord_password@localhost:3306/njord_db";
//     let mut conn = mysql::open(url);
...
//             let query1 = mysql::select(c, columns.clone())
//                 .from(User::default())
//                 .where_clause(condition1);

//             let query2 = mysql::select(c, columns.clone())
//                 .from(User::default())
//                 .where_clause(condition2);

//             let query3 = mysql::select(c, columns.clone())
//                 .from(User::default())
...
//     match conn {
//         Ok(c) => {
//             let sub_query = mysql::select(&c, vec![Column::Text("username".to_string())])
