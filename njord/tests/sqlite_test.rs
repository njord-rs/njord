...
fn select_except() {
    ...
    let query1_columns = vec![
        Column::Text("id".to_string()),
        Column::Text("username".to_string()),
        Column::Text("email".to_string()),
    ];
    let query2_columns = vec![
        Column::Text("id".to_string()),
        Column::Text("username".to_string()),
        Column::Text("email".to_string()),
    ];
    let query3_columns = vec![
        Column::Text("id".to_string()),
        Column::Text("username".to_string()),
        Column::Text("email".to_string()),
    ];
    ...
    match conn {
        Ok(c) => {
            ...
            let query1 = sqlite::select(&c, query1_columns)
                .from(User::default())
                .where_clause(condition1);

            let query2 = sqlite::select(&c, query2_columns)
                .from(User::default())
                .where_clause(condition2);

            let query3 = sqlite::select(&c, query3_columns)
                .from(User::default())
